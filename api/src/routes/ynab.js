...
import { getGoldPrice } from "../requests/gold.js";
import { getAccount, getAccountTransactions, postTransaction } from "../requests/ynab.js";
import {
...
router.post("/gold-stats-update", async (req, res) => {
...
router.get("/golden-update", async (req, res) => {
    const auth = authorize(req, res, "budget", "account-j", "account-n");
    if (!auth) {
        return;
    }
...
router.post("/golden-update", async (req, res) => {
    const auth = authorize(req, res, "budget", "account-j", "account-n");
...
router.get("/golden-update-single", async (req, res) => {
...
router.post("/golden-update-single", async (req, res) => {
    const auth = authorize(req, res, "budget", "account");
